        ...
        <div class="row">
                ...
                <div class="white-box">
                    ...
                    <div class="message-center">
                        <c:forEach var="task" items="${tasks}">
                            <c:if test="${task.statusName == 'Chưa thực hiện'}">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5><c:out value="${task.name}"/></h5>
                                        <span class="time">Bắt đầu: <c:out value="${task.startDate}"/></span>
                                        <span class="time">Kết thúc: <c:out value="${task.endDate}"/></span>
                                         <span>Dự án: <c:out value="${task.projectName}"/></span><br/>  <!-- Hiển thị tên dự án -->
                                		 <span>Người thực hiện: <c:out value="${task.userName}"/></span><br/> <!-- Hiển thị tên người thực hiện -->
                                    </div>
                                </a>
                            </c:if>
                        </c:forEach>
            ...
            <div class="col-md-4">
                <div class="white-box">
                    ...
                    <div class="message-center">
                        <c:forEach var="task" items="${tasks}">
                            <c:if test="${task.statusName == 'Đang thực hiện'}">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5><c:out value="${task.name}"/></h5>
                                        <span class="time">Bắt đầu: <c:out value="${task.startDate}"/></span>
            ...
            <div class="col-md-4">
                <div class="white-box">
                    ...
                    <div class="message-center">
                        <c:forEach var="task" items="${tasks}">
                            <c:if test="${task.statusName == 'Đã hoàn thành'}">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5><c:out value="${task.name}"/></h5>
                                        <span class="time">Bắt đầu: <c:out value="${task.startDate}"/></span>
