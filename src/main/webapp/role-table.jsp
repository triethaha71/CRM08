...
<!-- Thêm taglib directive để sử dụng JSTL Core -->
                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        <!-- Sử dụng JSTL để lặp qua danh sách roles -->
                                        <c:forEach var="role" items="${listRoles}" varStatus="status">
                                            <tr>
                                                <td>${status.index + 1}</td>  <%-- STT (index bắt đầu từ 0) --%>
                                                <td>${role.name}</td>
                                                <td>${role.description}</td>
                                                <td>
                                                    <a href="role-edit?id=${role.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                    <a href="role-delete?id=${role.id}" class="btn btn-sm btn-danger">Xóa</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
