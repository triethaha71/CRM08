...
<head>
    ...
    <title>Pixel Admin - Danh sách công việc</title>
    <!-- Bootstrap Core CSS -->
                                ...
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        <c:forEach var="task" items="${taskList}" varStatus="loop">
                                            <tr>
                                                <td><c:out value="${loop.index + 1}"/></td>  <%-- Thay bằng loop.index + 1 --%>
                                                <td><c:out value="${task.name}"/></td>
                                                <td><c:out value="${task.projectName}"/></td>  <!-- Hiển thị project name -->
                                                <td><c:out value="${task.userName}"/></td>   <!-- Hiển thị user name -->
